...
from keras.layers import Embedding, LSTM, Flatten, Dense, Conv1D, GlobalMaxPooling1D, Dropout, Activation
...
model.add(Conv1D(260, 3, padding='valid', activation='relu', strides=1))
